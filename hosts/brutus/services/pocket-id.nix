...
in {
  ...
  age.secrets = {
    ...
    "pocket-id/staticApiKey" = {
      file = ../secrets/pocket-id/staticApiKey.age;
    };
  };
  services.pocket-id = {
    ...
    credentials = {
      ...
      # TODO: make this randomly autogenerated
      STATIC_API_KEY = config.age.secrets."pocket-id/staticApiKey".path;
